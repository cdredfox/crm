                      ...
                      width="100%">
                        ...
                        border=0>
                          ...
                          <TR style="CURSOR: hand">
                            ...
                            width=10>&nbsp;</TD>
                            <TD class=View_title noWrap align=left>消息主题</TD>
                            <TD class=View_title noWrap align=middle>消息内容</TD>
                            <TD class=View_title noWrap align=left>消息要提醒的人</TD>
                            <TD class=View_title noWrap align=left>消息发布的日期</TD>
                         ...
                         <logic:notPresent name="list" scope="request">
                          ...
                          width="100%">
                            ...
                            <TD class=View_item2 noWrap align=middle>${li.mcontent}</TD>
                            <TD class=View_item2 noWrap align=middle>${li.eid}</TD>

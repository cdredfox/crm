...
function nowc(eid){
    CustomerAjax.getAllEnterprisecustomerByEmployye(eid,allcallback);
}
function findc(){
   var code=document.getElementById("code").value;
   CustomerAjax.getEnterprisecustomerByCcode(code,allcallback);
}
function findn(){
   var cname=document.getElementById("cname").value;
   alert(cname);
   CustomerAjax.getEnterprisecustomerByName(cname,allcallback);
}
...
{
	window.open(msg,"增加企业客户",'toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=no,resizable=yes,copyhistory=yes,width=450,height=490,left=0,top=0');
}


function reloadall()
{
	CustomerAjax.getAllCustomer("企业客户",allcallback);
}
//定义转换规则
...
var getcindus=function(unit){return unit.cindus};
var getcevaluate=function(unit){return unit.cevaluate};
var getcphone=function(unit){return unit.cphone};
var getcaddress=function(unit){return unit.caddress};
var getstyle=function(unit){return unit.style}
var getcremark=function(unit){return unit.cremark};
var getoper=function(unit){return "<div class='width:50px' onclick='modi("+unit.id+");'>修改</div>"};
function allcallback(msg)
{    
     if(msg.length!=0){
        DWRUtil.removeAllRows("enterprisecustomerlist");
        DWRUtil.addRows("enterprisecustomerlist",msg,[getid,getcname,getename,getcindus,getcevaluate,getcphone,getcaddress,getstyle,getcremark,getoper]);
       }else{
        DWRUtil.removeAllRows("enterprisecustomerlist");
        alert("没有找到相应的信息!");   
       }
...
function modi(id)
{
	window.open("/NetSoftCRM/enterprisecustomer.crm?method=modiView&id="+id,"修改企业客户",'toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=no,resizable=yes,copyhistory=yes,width=450,height=490,left=0,top=0');
}
</SCRIPT>
</HEAD>
      ...
      background=<%=request.getContextPath()%>/images/bar.gif border=0>
        ...
        <TR>
          ...
          <TD vAlign=center noWrap align=left>
            <P style="MARGIN-TOP: 4px">我的企业客户列表</P></TD></TR></TBODY></TABLE></TD></TR>
  <TR vAlign=top>
                          ...
                          <TR vAlign=top>
                            <TD vAlign=bottom>
                              ...
                              border=0>
                                ...
                                onmouseover="this.className='formKey_over'" 
                                style="CURSOR: hand" 
                                onclick="windowopen('/NetSoftCRM/jsp/addenterprisecustomer.jsp');" 
                                onmouseout="this.className='formKey'" 
                                vAlign=center width="55" align="center"><IMG class=icon0 
                                style="MARGIN-LEFT: 3px; CURSOR: hand" 
                      ...
                      width="100%">
                        ...
                        border=0>
                          ...
                          <TR style="CURSOR: hand">
                            ...
                            <TD class=View_title noWrap align=left>客户行业</TD>
                            <TD class=View_title noWrap align=middle>价值评估</TD>
                            <TD class=View_title noWrap align=middle>客户电话</TD>
                            <TD class=View_title noWrap align=left>客户地址</TD>
                            <TD class=View_title noWrap align=middle>客户状态</TD>
                            <TD class=View_title noWrap align=middle>客户备注</TD>
                            <TD class=View_title style="BORDER-RIGHT: 0px" 
                            noWrap align=middle>操作</TD></TR></THEAD>
                          <TBODY id="enterprisecustomerlist">
                         <logic:notPresent name="list" scope="request">
                          ...
                          width="100%">
                            ...
                            <TD class=View_item2 noWrap align=middle>${li.cevaluate}</TD>
                            <TD class=View_item2 noWrap align=middle>${li.cphone}</TD>
                            <TD class=View_item2 noWrap align=middle>${li.caddress}</TD>
                            <TD class=View_item2 noWrap align=middle>${li.style}</TD>
                            <TD class=View_item2 noWrap align=middle>${li.cremark}</TD>
                            <TD class=View_item2 style="BORDER-RIGHT: 0px" 
                            noWrap align=middle"><div class="width:50px" onclick="modi(${li.id});">修 改</div></TD></TR>
                            </logic:iterate>
                            </logic:present>

...
return true;
	...
	<html:form action="/employee?method=addUser" onsubmit="return check();">
		<table cellspacing=1 cellpadding=0 border=0 id=bgtable width=70%
			...
			<tr>
				...
				<td id=bgbody>
					<html:text property="eaccount" styleClass="myinput" readonly="true"></html:text>
				</td>
				<td id=bgtitle>
					姓 名
				</td>
			...
			<tr>
				...
				<td id=bgbody>
					<html:password property="epwd" value="123456" styleClass="myinput"></html:password>
				</td>
				<td id=bgtitle>
					确认密码
				</td>
				<td id=bgbody>
					<input type=password class=myinput name=conword value="123456"
						styleClass="myinput" />
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td align=center colspan=4 id=bgtitle>
					<html:submit value="增加用户" styleClass="mybutton"></html:submit>
				</td>
			</tr>
		</table>
	</html:form>

...
LETTER-SPACING: 1px } </STYLE>
  ...
  <script type='text/javascript' src='/NetSoftCRM/dwr/util.js'></script>
	<script type="text/javascript">
		...
		function getCustomer(url,name,style)
		{
			window.open(url,name,style);
		}
		
		function getEmployye(url,name,style)
		{
			window.open(url,name,style);
		}
function GetDate ()
	{
	  ...
	  if (reVal != null)
	  {
	     document.forms[0].splanenddate.value=reVal;
	  }
	  }
...
>
    <IMG src="<%=request.getContextPath()%>/images/save.gif" align=absBottom> 修改</SPAN>
...
<html:form action="/sellitem?method=modiSellitem">
			<html:hidden property="id" value="${ib.id}"/>
			<TABLE cellPadding=3 width="100%">
				<TBODY>
				<tr>
		   <td colspan="2" height="21" bgcolor="#E17E5E" align="center"><font color="#FFFFFF">修改项目</font></td>
		 </tr>
					<TR>
						<td>
						项目名称：
					...
					<TR>
						...
						<TD>
							<html:text property="cid" readonly="true" styleClass="ip_text disabled" value="${ib.cname}"/>
						</TD>
						</tr>
					<TR>
						<TD>
						...
						<TD>
							<html:text property="checkempid" readonly="true" styleClass="ip_text disabled" value="${ib.checkname}"></html:text>
						</TD>
					</TR>
					<TR>
						<TD>
					...
					<TR>
						...
						<TD height="15">
							<html:textarea property="smessage" rows="8"></html:textarea>
						</TD>
					</TR>

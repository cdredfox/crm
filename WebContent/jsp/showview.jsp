...
function onPage(page,topid)
	{
		...
		document.forms[0].action="/NetSoftCRM/notebook.crm?method=showView&id="+ topid;
	...
	function callback(msg)
	{
		...
		window.location.href("/NetSoftCRM/notebook.crm?method=getAll");
	}
	</script>
	</HEAD>
	<BODY bgcolor="#F5F9FA" rightMargin=50 leftMargin=50 topMargin=3
		...
		<BR>
		<title>天涯上海网友网上联系方法</title>
		<table border=0 width=100% align=center>
			<td>
				<TABLE align=center border=0 borderColor=#ffffff cellPadding=2
					cellSpacing=2>
					<TR>
						<TD align=center bgColor=#336699>
							<FONT color=#ffffff size=+1>
								<div
									style="height: 8; color: white; filter: glow(color =                   red, strength =                   5)">
									${title}
							</font>
						</TD>
					</TR>
		...
		<html:form action="/notebook.crm?method=showView&type=notebook">
			...
			<table id=t1 name=t1 cellspacing=1 cellpadding=0 border=0
				...
				<html:form action="/notebook?method=addNoteBook"
					...
					<table width="100%">
						...
						<tr>
							<td>
								<html:submit value="回复贴子"></html:submit>
							</td>
						</tr>
					</table>
				</html:form>

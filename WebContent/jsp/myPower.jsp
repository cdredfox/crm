...
LETTER-SPACING: 1px } </STYLE>
  ...
  <body>
    <html:form action="/menus?method=removePower&pid=${rid}">
   		<table>
   			<logic:present name="myPower">
   			<logic:iterate name="myPower" id="mp" indexId="id">
   		...
   		<logic:notPresent name="myPower">  		<tr>	<td>对不起。您没有任何权限</td>
   		</tr></logic:notPresent>   		
   		<tr>
   		...
   		<table>
   			...
   			<td><font color="red">温馨小提示：<br/>
   					蓝色加粗字体表示的选项为主菜单,您取消掉主菜单权限后。其子菜单自动取消权限。</font>
   			</td>
   		</tr>
   		</table>
   		</html:form>

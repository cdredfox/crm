...
<html:form action="/role?method=addRole">
			<TABLE align="center">
				<TBODY>
					<TR>
						<TD>
						...
						<td valign="top"><br></td><TD>
							<html:text property="rname" styleClass="ip_text" maxlength="30"></html:text>
						<br></TD>
						</tr>
					<TR>
						<TD valign="top">
						...
						<td valign="top"><br></td><TD>
							<html:textarea property="rmessage" rows="10" ></html:textarea>
						<br></TD>
						</tr>
					<tr>
					<td><br></td>
					<td valign="top"><br></td><td><p><font color="red">${msg}</font></p></td>
					</tr>
					</TBODY>
			</TABLE>
		</html:form>

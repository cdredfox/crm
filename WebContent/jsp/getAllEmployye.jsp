...
{
	opener.document.all.checkempid.value=id;
	opener.document.all.checkname.value=name;
	window.close();
}
</SCRIPT>
</HEAD>
      ...
      background=<%=request.getContextPath()%>/images/bar.gif border=0>
        ...
        <TR>
          ...
          <TD vAlign=center noWrap align=left>
            <P style="MARGIN-TOP: 4px">所有员工列表</P></TD></TR></TBODY></TABLE></TD></TR>
  <TR vAlign=top>
                      ...
                      width="100%">
                        ...
                        border=0>
                          ...
                          <TR style="CURSOR: hand">
                            ...
                            align=left>员工姓名</TD>
                            <TD class=View_title noWrap align=middle>员工帐号</TD>
                            <TD class=View_title noWrap 
                            align=left>部门</TD>
                         ...
                         <logic:notPresent name="list" scope="request">
                          ...
                          width="100%">
                            ...
                            <TD class=View_item2 noWrap align=middle>${li.eaccount}</TD>
                            <TD class=View_item2 noWrap align=middle>${li.deptsName}</TD>
                            <TD class=View_item2 noWrap align=middle>${li.esex==0?"男":"女"}</TD>
                            <TD class=View_item2 style="BORDER-RIGHT: 0px" 
                            noWrap align=middle" onclick="pass(${li.id },'${li.ename }');"><img src="<%=request.getContextPath()%>/images/prev.gif"></TD>
                            </TR>
                            </logic:iterate>
                            </logic:present>

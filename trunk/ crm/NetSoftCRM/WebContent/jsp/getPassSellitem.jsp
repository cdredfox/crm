...
{
	opener.document.all.xmid.value=id;
	opener.document.all.sname.value=name;
	window.close();
}
</SCRIPT>
</HEAD>
                      ...
                      width="100%">
                        ...
                        border=0>
                          ...
                          <TR style="CURSOR: hand">
                            ...
                            width=10>&nbsp;</TD>
                            <TD class=View_title noWrap align=middle>项目名称</TD>
                            <TD class=View_title noWrap 
                            align=left>对应客户</TD>
                            <TD class=View_title noWrap align=left>项目状态</TD>
                            <TD class=View_title style="BORDER-RIGHT: 0px" 
                            noWrap align=middle>选择</TD></TR></THEAD>
                          <TBODY>
                         <logic:notPresent name="passed" scope="request">
                            <tr><td>数据库中没有任何记录</td></tr>
                          </logic:notPresent>
                          <logic:present name="passed" scope="request">
                          <logic:iterate id="li" name="passed" scope="request">
                          ...
                          width="100%">
                            ...
                            noWrap align=middle" onclick="pass(${li.id },'${li.sname }');"><img src="<%=request.getContextPath()%>/images/prev.gif"></TD>
                            </TR>
                            </logic:iterate>
                            </logic:present>
